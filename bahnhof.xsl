         ...
         <body>
            <xsl:for-each select="bahnhof">
               <table border="1">
                  ...
                  <tr>
                     <td class="links" colspan="6">Betriebsstelle: <span><xsl:value-of select="name"/></span></td>
                     <td class="links" colspan="2"><xsl:text disable-output-escaping="yes">Kürzel: </xsl:text><span><xsl:value-of select="kuerzel"/></span></td>
                     <td class="links" colspan="2"><xsl:text disable-output-escaping="yes">Verwaltung: </xsl:text><span><xsl:value-of select="verwaltung"/></span></td>
                  </tr>
                  <tr>
